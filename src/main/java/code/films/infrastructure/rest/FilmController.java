...
import code.films.domain.client.commands.handlers.CreateFilmHandler;
import code.films.domain.client.queries.handlers.GetFilmsHandler;
import code.films.domain.client.commands.handlers.CreateScreeningHandler;
import code.films.domain.client.queries.handlers.GetScreeningHandler;
import code.films.domain.client.queries.handlers.GetScreeningSeatsHandler;
