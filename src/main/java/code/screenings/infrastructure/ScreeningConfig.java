...
import code.screenings.application.*;
import code.screenings.domain.CurrentOrNextOneYearScreeningDateSpecification;
import code.screenings.domain.FilmRepository;
import code.screenings.domain.PreviousCurrentOrNextOneFilmYearSpecification;
